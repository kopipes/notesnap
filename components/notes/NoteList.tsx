...
function NoteCardSkeleton() {
  return (
    <div className="bg-white rounded-2xl border border-slate-200 px-4 py-3.5 animate-pulse">
      <div className="h-3.5 bg-slate-100 rounded-lg w-2/3 mb-2" />
  ...
  if (error) {
    return (
      <div className="flex flex-col items-center justify-center py-20 text-center">
        ...
        <p className="text-slate-600 text-sm font-medium">Gagal memuat</p>
  ...
  if (notes.length === 0) {
    return (
      <div className="flex flex-col items-center justify-center py-24 text-center">
        <div className="w-16 h-16 rounded-3xl bg-sky-50 flex items-center justify-center mb-4">
          <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor" className="w-8 h-8 text-sky-300">
            <path d="M21.731 2.269a2.625 2.625 0 00-3.712 0l-1.157 1.157 3.712 3.712 1.157-1.157a2.625 2.625 0 000-3.712zM19.513 8.199l-3.712-3.712-12.15 12.15a5.25 5.25 0 00-1.32 2.214l-.8 2.685a.75.75 0 00.933.933l2.685-.8a5.25 5.25 0 002.214-1.32L19.513 8.2z" />
          </svg>
        </div>
        <p className="text-slate-700 font-semibold text-sm">Belum ada catatan</p>
        <p className="text-slate-400 text-xs mt-1.5 max-w-[180px] leading-relaxed">
