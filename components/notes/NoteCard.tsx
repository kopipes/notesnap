  ...
  return (
    <Link
      ...
      className="
        ...
        hover:border-sky-300 dark:hover:border-sky-700 hover:shadow-md hover:shadow-sky-100 dark:hover:shadow-sky-900/20
    ...
    >
      ...
      <svg
        ...
        viewBox="0 0 24 24"
        fill="currentColor"
        className="w-4 h-4 text-slate-300 dark:text-slate-600 group-hover:text-sky-400 transition-colors shrink-0 ml-3"
      >
